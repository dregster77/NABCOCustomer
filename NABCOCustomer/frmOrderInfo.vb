...
#End Region
    ...
    Private Sub gvCustomer_DoubleClick(sender As Object, e As EventArgs)
    ...
    Public Sub SaveOrder()
        Try
            SQL = "Update t_quote set " &
                "customer_po= '" & IIf(txtCustPO.Text = "", txtCustPO.Text, "Null") & "', " &
                "job_name= '" & IIf(txtJobName.Text = "", txtJobName.Text, "Null") & "', " &
                "shipping_method= '" & ddlShippingMethod.SelectedItem.Text & "', " &
                "customer_contact= '" & IIf(txtCustContact.Text = "", txtCustContact.Text, "Null")
            If txtCustNoShipTP.Text <> "" Then
                SQL &= "', " & "ship_cust_num=  '" & txtCustNoShipTP.Text
            End If
            If txtCustNoShipTP.Text <> "" Then
                SQL &= "', " & "sold_cust_num= '" & txtCustNoSoldTP.Text
            End If
            SQL &= "')"
            Execute()
        Catch ex As Exception
